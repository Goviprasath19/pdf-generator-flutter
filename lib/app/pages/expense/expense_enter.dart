...
class ExpenseEnter extends StatefulWidget {
  const ExpenseEnter({super.key});

  @override
  State<ExpenseEnter> createState() => _ExpenseEnterState();
}

class _ExpenseEnterState extends State<ExpenseEnter> {
  var uuid = '';
  ...
  _addExpense() async {
    ...
    await FirebaseFirestore.instance.collection('expense').doc(uuid).set({
  ...
  Future<String> generateSequenceNumber() async {
    ...
    return 'SH' '/' + sequenceNumber + '/' '2023-24';
  }
  ...
  Future<void> _uploadImage(Uint8List imageBytes) async {
    try {
      ...
      firebase_storage.Reference ref = firebase_storage.FirebaseStorage.instance
          .ref()
          .child('/documents/expenses/expenses-$fileName.jpg');
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: ElevatedButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                if(_companyNameController.text.isEmpty || _addressController.text.isEmpty || _cityController.text.isEmpty||_countryController.text.isEmpty ||_stateController.text.isEmpty||_pinCodeController.text.isEmpty){
                                                  print('object');
                                                  setState(() {
                                                    _addNewCompany = true;
                                                    _defaultLoading = false;
